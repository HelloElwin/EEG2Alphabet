...
def ParseArgs():
    ...
    parser.add_argument('--reg_cont', default=1e-6, type=float, help='weight decay regularizer')
    parser.add_argument('--reg_clus', default=1e-6, type=float, help='clustering regularizer')
